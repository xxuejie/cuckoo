...
describe "url helper" do
  it "should encode a URI" do
    ...
    expect(Helpers::encode_uri original_str).to eq(encoded_str)
  end
  ...
  it "should normalize email into gravatar url" do
    ...
    expect(Helpers::normalize_avatar_url "test@example.com").to eq(avatar)
  end
  ...
  it "should not change avatar which is already an url" do
    ...
    expect(Helpers::normalize_avatar_url avatar).to eq(avatar)
  end
end
